...
var HomePage = React.createClass({
    ...
    getInitialState: function () {
        ...
        feed.onChange(function (stock) {
            ...
            self.setState({ stocks: stocks, last: stock });
        });
        return {
            stocks: this.props.stocks,
            last: this.props.lastStock
        };
    },
    ...
    render: function () {
        return React.createElement(
            ...
            React.createElement(StockTable, { stocks: this.state.stocks, last: this.state.last, unwatchStockHandler: this.unwatchStock }),
            React.createElement(
                "div",
                { className: "row" },
                React.createElement(
...
ReactDOM.render(React.createElement(HomePage, null), document.getElementById("example"));
